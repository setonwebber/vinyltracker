...
empty definition using pc, found symbol in pc: findArtistID.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -functions/artistsObject/findArtistID.
	 -functions/artistsObject/findArtistID#
	 -functions/artistsObject/findArtistID().
	 -genres/artistsObject/findArtistID.
	 -genres/artistsObject/findArtistID#
	 -genres/artistsObject/findArtistID().
	 -artists/artistsObject/findArtistID.
	 -artists/artistsObject/findArtistID#
	 -artists/artistsObject/findArtistID().
	 -artistsObject/findArtistID.
	 -artistsObject/findArtistID#
	 -artistsObject/findArtistID().
	 -scala/Predef.artistsObject.findArtistID.
	 -scala/Predef.artistsObject.findArtistID#
	 -scala/Predef.artistsObject.findArtistID().
offset: 14305
            ...
            val artistsIDs: List[Int] = {
                ...
                while (running) {
                    ...
                    if (input.isEmpty) {
                        ...
                        artistsObject.fin@@dArtistID(input) match {
                            case Some(id) =>
