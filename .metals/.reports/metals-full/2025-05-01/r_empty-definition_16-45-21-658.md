...
empty definition using pc, found symbol in pc: findGenreID.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -functions/genresObject/findGenreID.
	 -functions/genresObject/findGenreID#
	 -functions/genresObject/findGenreID().
	 -genres/genresObject/findGenreID.
	 -genres/genresObject/findGenreID#
	 -genres/genresObject/findGenreID().
	 -artists/genresObject/findGenreID.
	 -artists/genresObject/findGenreID#
	 -artists/genresObject/findGenreID().
	 -genresObject/findGenreID.
	 -genresObject/findGenreID#
	 -genresObject/findGenreID().
	 -scala/Predef.genresObject.findGenreID.
	 -scala/Predef.genresObject.findGenreID#
	 -scala/Predef.genresObject.findGenreID().
offset: 21858
                    ...
                    while (editing) {
                        ...
                        readLine("> ") match {
                            ...
                            case "7" =>
                                ...
                                // use findArtistID to see if the artist already exist
                                genresObject.findG@@enreID(input) match {
                                    case Some(id) =>
